//
// Created by LuoYu on 2025/12/15.
//
...
Enemy::Enemy() {
    ...
    hurt_box->set_layer_dst(CollisionLayer::Player);
    ...
    {
        {
            ...
            animation_aim_left.set_interval(.05f);
            ...
            animation_aim_right.set_interval(.05f);
        ...
        }
        {
            ...
            animation_dash_in_air_left.set_interval(.05f);
            ...
            animation_dash_in_air_right.set_interval(.05f);
        ...
        }
        {
            ...
            animation_dash_on_floor_left.set_interval(.05f);
            ...
            animation_dash_on_floor_right.set_interval(.05f);
            ...
            animation_dash_on_floor_right.add_frame(
                ResourceManager::instance()->find_atlas("enemy_dash_on_floor_right")
            );
        }
        {
            ...
            animation_fall_left.set_interval(.1f);
            ...
            animation_fall_right.set_interval(.1f);
        ...
        }
        {
            ...
            animation_idle_left.set_interval(.1f);
            ...
            animation_idle_right.set_interval(.1f);
        ...
        }
        {
            ...
            animation_jump_left.set_interval(.1f);
            ...
            animation_jump_right.set_interval(.1f);
        ...
        }
        {
            ...
            animation_run_left.set_interval(.05f);
            ...
            animation_run_right.set_interval(.05f);
        ...
        }
        {
            ...
            animation_squat_left.set_interval(.05f);
            ...
            animation_squat_right.set_interval(.05f);
        ...
        }
        {
            ...
            animation_throw_barb_left.set_interval(.1f);
            ...
            animation_throw_barb_right.set_interval(.1f);
        ...
        }
        {
            ...
            animation_throw_silk_left.set_interval(.1f);
            ...
            animation_throw_silk_right.set_interval(.1f);
        ...
        }
        {
            ...
            animation_throw_sword_left.set_interval(.05f);
            ...
            animation_throw_sword_right.set_interval(.05f);
    ...
    {
        animation_silk.set_interval(.1f);
        ...
        animation_dash_in_air_left.set_interval(.1f);
        ...
        animation_dash_in_air_right.set_interval(.1f);
        ...
        animation_dash_on_floor_left.set_interval(.1f);
        ...
        animation_dash_on_floor_right.set_interval(.1f);
...
void Enemy::on_update(float delta) {
    if (velocity.x >= .0001f) is_facing_left = velocity.x < 0;
    ...
    if (is_dashing_in_air or is_dashing_on_floor) {
    ...
    std::erase_if(
        barb_list,
        [](const Barb* barb) {
            bool can_remove = not barb->check_valid();
    ...
    std::erase_if(
        sword_list,
        [](const Sword* sword) {
            bool can_remove = not sword->check_valid();
...
void Enemy::on_render() {
    ...
    if (is_dashing_in_air or is_dashing_on_floor) current_dash_animation->on_render();
}
...
void Enemy::throw_barbs() {
    int num_new_barb = range_random(2, 7);
    if (barb_list.size() >= 10) num_new_barb = range_random(1, 2);
...
void Enemy::on_dash() {
    if (is_dashing_in_air)
        current_dash_animation = velocity.x < 0
                                     ? &animation_dash_in_air_vfx.left
                                     : &animation_dash_in_air_vfx.right;
    else current_dash_animation = velocity.x < 0
                                      ? &animation_dash_on_floor_vfx.left
                                      : &animation_dash_on_floor_vfx.right;
