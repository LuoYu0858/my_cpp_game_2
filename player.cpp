...
Player::Player() {
    ...
    {
        {
            ...
            animation_attack_left.set_interval(.05f);
            ...
            animation_attack_right.set_interval(.05f);
        ...
        }
        {
            ...
            animation_dead_left.set_interval(.1f);
        ...
        }
        {
            ...
            animation_fall_left.set_interval(.15f);
        ...
        }
        {
            ...
            animation_idle_left.set_interval(.15f);
        ...
        }
        {
            ...
            animation_jump_left.set_interval(.15f);
        ...
        }
        {
            ...
            animation_roll_left.set_interval(.15f);
    ...
    animation_slash_up.set_interval(.07f);
    ...
    animation_slash_down.set_interval(.07f);
    ...
    animation_slash_left.set_interval(.07f);
    ...
    animation_slash_right.set_interval(.07f);
    ...
    animation_jump_vfx.set_interval(.05f);
    ...
    animation_land_vfx.set_interval(.05f);
