...
#ifndef HOLLOWSAMURAI_CHARACTER_H
#define HOLLOWSAMURAI_CHARACTER_H
...
protected:
    const float FLOOR_Y = 620;      // 地板的数值方向坐标
...
protected:
    ...
    std::unordered_map<std::string, AnimationGroup> animation_pool; // 角色动画吃
};

#endif //HOLLOWSAMURAI_CHARACTER_H